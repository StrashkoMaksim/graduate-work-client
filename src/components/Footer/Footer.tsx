...
import YandexIcon from '../../assets/img/yandex_star.svg'
...
const Footer = () => {
    return (
        <footer className="footer" id="footer">
                ...
                <div className={cn('container', styles.container)}>
                    <div className={styles.grid}>
                        ...
                        <div className={styles.services}>
                            <a href="#" className={styles.servicesMain}>Каталог</a>
                            <a href="#" className={styles.servicesItem}>Лазерные станки</a>
                            <a href="#" className={styles.servicesItem}>Фрейзерные станки</a>
                            <a href="#" className={styles.servicesItem}>Режущие плоттеры</a>
                        </div>
                        ...
                        <div className={styles.buttons}>
                            ...
                            <div className={styles.buttonsYandex}>
                                ...
                                <a href="#" className={styles.contactsReview}>
                                    <img src={YandexIcon} alt="Я.Карты" />
                                    <span>
            ...
            <div className={cn('section', styles.copyright)}>
                <div className={cn('container', styles.container)}>
                    <a href="#">© 2022, CNC Solutions</a>
                    <span> | </span>
