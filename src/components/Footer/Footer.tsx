    ...
    return (
        <footer className="footer" id="footer">
                ...
                <div className={cn('container', styles.container)}>
                    <div className={styles.grid}>
                        ...
                        <div className={styles.services}>
                            <Link to="#" className={styles.servicesMain}>Каталог</Link>
                            <Link to="#" className={styles.servicesItem}>Лазерные станки</Link>
                            <Link to="#" className={styles.servicesItem}>Фрейзерные станки</Link>
                            <Link to="#" className={styles.servicesItem}>Режущие плоттеры</Link>
                        </div>
            ...
            <div className={cn('section', styles.copyright)}>
                <div className={cn('container', styles.container)}>
                    <Link to="#">© 2022, CNC Solutions</Link>
                    <span> | </span>
